...
rm -f "bareiron$exe"
$compiler src/*.c src/noise/*.c src/cubiomes/biomenoise.c src/cubiomes/biomes.c src/cubiomes/finders.c src/cubiomes/generator.c src/cubiomes/layers.c src/cubiomes/noise.c src/cubiomes/quadbase.c src/cubiomes/util.c -O2 -Iinclude -Isrc/cubiomes -o "bareiron$exe" $windows_linker -lm
"./bareiron$exe"
